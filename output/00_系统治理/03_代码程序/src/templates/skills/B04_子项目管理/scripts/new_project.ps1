...
.DESCRIPTION
    Creates a stable sub-project directory following naming convention:
    output\{Number}_{Topic}
    Inside the project, creates three sub-folders:
      01_问题答疑\   (empty placeholder)
      02_课题研究\   (empty placeholder)
      03_代码程序\   (empty placeholder)
...
$folderName = "${projectNumber}_${Topic}"
...
# Create three stable sub-folders.
$subFolders = @("01_问题答疑", "02_课题研究", "03_代码程序")
