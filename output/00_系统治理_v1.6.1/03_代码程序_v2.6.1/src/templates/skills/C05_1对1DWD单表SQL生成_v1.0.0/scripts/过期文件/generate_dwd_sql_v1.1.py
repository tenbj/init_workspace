...
输出：
    <project_root>/output/C05_1对1DWD单表SQL生成_v1.0.0/<dwd_table_name>/<dwd_table_name>.sql
    <project_root>/output/C05_1对1DWD单表SQL生成_v1.0.0/<dwd_table_name>/<dwd_table_name>.md  （有异常时）
"""
