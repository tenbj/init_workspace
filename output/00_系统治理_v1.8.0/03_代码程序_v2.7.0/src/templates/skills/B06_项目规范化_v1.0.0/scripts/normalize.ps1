...
if (Test-Path $agents) {
    $requiredSkills = if ($workspaceSpec) { @($workspaceSpec.overwriteLayer.skills) } else { @("A01_创建技能_v1.0.0","B04_子项目管理_v1.0.0","A02_安装技能_v1.0.0","B01_框架体检_v1.0.0","B02_版本控制备份_v1.0.0","B03_记忆管理_v1.0.0","B06_项目规范化_v1.0.0","B05_课题研究_v1.0.0") }
