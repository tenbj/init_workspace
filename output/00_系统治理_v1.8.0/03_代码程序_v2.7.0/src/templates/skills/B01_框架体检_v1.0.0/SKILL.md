---
name: B01_框架体检_v1.0.0
description: 框架健康自检技能。会话开始时或批量修改后执行只读检查：SSOT 标准读取、对话记录完整性、.ps1 BOM状态、.memory洁净度、知识地图对齐、input/路径污染、子项目内部结构。只报问题不修复。
---
...
| 8 | 子项目三分类结构 | 新结构或空子项目缺少 `01_问题答疑_v*`、`02_课题研究_v*`、`03_代码程序_v*`，或分类版本与内容集合状态不一致 |
