...
1. 将 `output/1对1DWD单表SQL生成/dwd_fin_lx_finance_report_msku_list_flu_dd/` 整个移入 `output/01_DWD开发产物_v1.0.0/03_代码程序_v1.0.0/`
2. 删除空的 `output/1对1DWD单表SQL生成/`
3. 将 `03_代码程序_v0.0.0` 重命名为 `03_代码程序_v1.0.0`（首次有内容）
...
- [ ] `output/` 下无不合规文件夹
- [ ] `01_DWD开发产物_v1.0.0/03_代码程序_v1.0.0/` 下有迁入的 DWD 产物
