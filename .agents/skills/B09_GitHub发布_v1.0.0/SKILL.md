...
1. 先运行 `scripts/update_init_program.ps1` 更新 `output/00_系统治理_v*/03_代码程序_v*/src` 内的初始化程序：全量刷新 `src/templates`，同步版本常量，并生成 `.b09_update_manifest.json`。
